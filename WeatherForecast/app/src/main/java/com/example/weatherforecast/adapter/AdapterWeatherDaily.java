...
public class AdapterWeatherDaily extends RecyclerView.Adapter<AdapterWeatherDaily.WeatherDailyViewHolder> {
     ...
     */
    public AdapterWeatherDaily(Context context, ArrayList<WeatherHour> weatherHourList) {
        this.context = context;
        this.weatherHourList = weatherHourList;
    }

    /**
     * Trả về 1 danh sách thời tiết theo ngày
     * @return
     */
    ...
    /**
     * Tạo WeatherDailyViewHolder kế thừa từ ViewHolder trong RecyclerView
     */
